...
fn main() {
    ...
    // Japanese encodings - JIS X 0208 table (shared by EUC-JP and ISO-2022-JP)
    #[cfg(any(feature = "euc-jp", feature = "iso-2022-jp"))]
...
fn build_gb18030() {
    ...
    // Parse WHATWG gb18030-index.txt for 2-byte mappings (preferred, includes Euro etc.)
    let index_path = Path::new("data/gb18030-index.txt");
    ...
    // Parse gb18030-ranges.txt for 4-byte algorithmic ranges
    let ranges_path = Path::new("data/gb18030-ranges.txt");
    ...
    println!("cargo:rerun-if-changed=data/gb18030-index.txt");
    println!("cargo:rerun-if-changed=data/mappings/windows/CP936.TXT");
    println!("cargo:rerun-if-changed=data/gb18030-ranges.txt");
}
...
// ============================================================================
// JIS tables for EUC-JP and ISO-2022-JP
// ============================================================================
